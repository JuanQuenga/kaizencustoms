<script lang="ts">
	...
	import HeroSection from '../components/navs/HeroSection.svelte';
	import MobileNavigation from '../components/navs/MobileNavigation.svelte';
	import Navigation from '../components/navs/Navigation.svelte';
	...
	<main>
		...
		<IntersectionObserver let:intersecting>
			<section
				...
				class:translate-x-0={intersecting}
				class:-translate-x-full={!intersecting}
